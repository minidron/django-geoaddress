...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseAddress.apartment'
        db.alter_column(u'django_geoaddress_baseaddress', 'apartment', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'BaseAddress.apartment'
        db.alter_column(u'django_geoaddress_baseaddress', 'apartment', self.gf('django.db.models.fields.CharField')(max_length=5))
